...
import { useSubGolonganList, useCreateMasterData, useUpdateMasterData, useDeleteMasterData, useRestoreMasterData } from '../../../hooks/useMasterData';
...
const SubGolonganPage: React.FC = () => {
    ...
    const { data, isLoading } = useSubGolonganList({ page, limit: 10, search, status, only_deleted: showDeleted });
    ...
    const restoreMutation = useRestoreMasterData('sub-golongan');
    ...
    return (
        <MasterDataLayout view={layout}>
            <div className="space-y-6">
                ...
                <SearchFilter onSearchChange={setSearch} onFilterChange={(v) => { setStatus(v); setPage(1); }} statusValue={status} onAdd={handleAdd} addButtonText="Tambah Sub Golongan" transparent={true} />
