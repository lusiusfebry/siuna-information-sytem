...
import { useDivisiList, useCreateMasterData, useUpdateMasterData, useDeleteMasterData, useRestoreMasterData } from '../../../hooks/useMasterData';
...
const DivisiPage = () => {
    ...
    // Hooks
    const { data, isLoading } = useDivisiList({ page, limit: 10, search, status, only_deleted: showDeleted });
    ...
    const restoreMutation = useRestoreMasterData('divisi');

    const handleRestore = (item: Divisi) => {
