...
import { useLokasiKerjaList, useCreateMasterData, useUpdateMasterData, useDeleteMasterData, useRestoreMasterData } from '../../../hooks/useMasterData';
...
const LokasiKerjaPage: React.FC = () => {
    ...
    const { data, isLoading } = useLokasiKerjaList({ page, limit: 10, search, status, only_deleted: showDeleted });
    ...
    const restoreMutation = useRestoreMasterData('lokasi-kerja');
